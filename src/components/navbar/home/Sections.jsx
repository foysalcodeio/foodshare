            ...
            <section className="pt-8 lg:pt-32 bg-center bg-cover">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
                    <div className="border border-light-orange p-1 w-60 mx-auto rounded-full flex items-center justify-between mb-4">
                        ...
                        <button
                            className="w-8 h-8 rounded-full flex justify-center items-center bg-light-orange"
                    ...
                    <h1 className="max-w-2xl mx-auto text-center font-manrope font-bold text-4xl text-hash-green mb-5 md:text-5xl leading-[50px]">
